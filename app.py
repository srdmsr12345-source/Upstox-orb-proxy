...
@app.route(
    "/api/v2/historical-candle/<path:instrument_key>/<interval>/<to_date>",
    methods=["GET"]
)
def historical_candle(instrument_key, interval, to_date):
    return forward_request(
        f"v2/historical-candle/{instrument_key}/{interval}/{to_date}"
    )


@app.route(
    "/api/v2/historical-candle/<path:instrument_key>/<interval>/<to_date>/<from_date>",
    methods=["GET"]
)
def historical_candle_range(
    instrument_key,
    interval,
    to_date,
    from_date
